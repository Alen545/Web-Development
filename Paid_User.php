...
<div class="w3l-grids-block-5 py-5">
        <section id="grids5-block" class="pt-md-4 pb-md-5 py-4 mb-5">
            <div class="container">
                ...
                <?php
 $qry = "SELECT `user_reg`.*,`payment`.* FROM `addrequest`,`user_reg`,`payment`,`addads` WHERE `addrequest`.`rid`=`payment`.`rid` AND `addads`.`anid`=`addrequest`.`anid` AND`addrequest`.`uid`=`user_reg`.`uid` AND `payment`.`status`='yes'";
