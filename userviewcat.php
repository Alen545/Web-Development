    ...
    <div class="w3l-index-block4 pb-5">
        <div class="features-bg pb-lg-5 pt-lg-4 py-4">
            <div class="container">
                ...
                <?php
            $cidv=  $_SESSION['uid'];
        $qry = "SELECT `addads` . * , `category` . * , `news_reg` . *
        FROM `addads` , `category` , `news_reg`
        WHERE `addads`.cid = `category`.cid
        AND `news_reg`.nid = addads.nid";
                ...
                <div class="col-lg-5 features15-col-text">
                        <a href="" class="d-flex feature-unit align-items-center">
                            ...
                            <div class="col-12">
                                ...
                                <p>Company Name :<?php echo  $row['name'] ?> 
                                <hr style='color:red'>
