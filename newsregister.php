        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    ...
                    <img class="img-fluid" src="assets/images/stats3.png" alt=" "> BookmyAd
                    </a>
                </h1>
...
<h2>News Paper Sign Up</h2>
<br><br><br>
<form>
    <input type="radio" ><br>
    <div class="form-group">
        <input class="form-control" type="text" name="name" id="w3lSender" placeholder="Company Name" required="">
    </div>
    <div class="form-group">
        <input class="form-control" type="text" name="email" id="w3lSender" placeholder="Email" required="">
    </div>
    <div class="form-group">
        <input class="form-control" type="text" name="phone" id="w3lSender" placeholder="Phone number"
    ...
    <div class="form-group">
        <input class="form-control" type="text" name="iso" id="w3lName" placeholder="ISO certificate Number" required="">
    </div>
    <div class="form-group">
        <input class="form-control" type="text" name="pass" id="w3lName" placeholder="Password" required="">
    </div>
    <img src="assets/images/pay.png" width="790px" height="150px" >

    <div class="form-group">
                    <input class="form-control" type="text" name="cname" id="w3lSender" placeholder="Card Name" required="" minlength="4">
                </div>
                 <div class="form-group">
                    <input class="form-control" type="text" name="card" id="w3lSender" placeholder="Card Number" required="" minlength="16" maxlength="16">
                </div>

                <div class="form-group">
                    <input class="form-control" type="text" name="cvv" id="w3lSender" placeholder="CVV" required="" minlength="3" maxlength="3">
                </div>
                ...
                <div class="form-group">
                    <input class="form-control" type="number" name="amount" id="w3lSender" placeholder="Amount" required="" readonly minlength="4" value="5000">
                </div>
    <div class="input-group1 text-right">
        <button class="btn button-style" type="submit" name="newssubmit">SiginUp
...
include('dbConnection.php');
            if (isset($_REQUEST['newssubmit'])) {
                ...
                $ios1=$_REQUEST['pdate'];
                echo '$nam';
                $qryReg="insert into  news_reg(name,email,phone,address,iso,pass,amount)values('$nam','$em','$num','$add','$ios','$pa','$amount')";    
$qryLog = "INSERT INTO login(reg_id,email,password,type,status)values((select max(nid)from news_reg),'$em','$pa','NEWS','no')";
                if ($conn->query($qryReg) == TRUE && $conn->query($qryLog) == TRUE) {
                    echo "<script>alert('Register Sucessfully');window.location='login.html'</script>";
                } else {
